...
//
//	// 创建窗口
//	GLFWwindow* window = glfwCreateWindow(WINDOW_WIDTH, WINDOW_HEIGHT, u8"张小锋8002119102", NULL, NULL); //在此处修改窗口标题
//	if (window == NULL)
//	{
//		glfwTerminate();
//		return -1;
...
//
//	// 初始化模型、视图、投影矩阵
//	mMat = glm::translate(glm::mat4(1.0f), glm::vec3(1.0f, 0.0f, 0.0f));
//	vMat = glm::mat4(1.0f);
//	pMat = glm::mat4(1.0f);
//
//	vMat = glm::lookAt(glm::vec3(0, 0, 2), glm::vec3(0, 0.5, 0), glm::vec3(0, 1, 0));
